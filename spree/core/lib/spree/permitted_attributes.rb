module Spree
  module PermittedAttributes
    ...
    @@line_item_attributes = [:id, :variant_id, :quantity, :group_number, :card_id, :price ]
    ...
    @@user_attributes = [:email, :username, :mobile, :password, :password_confirmation, :birth, :address, :memo]

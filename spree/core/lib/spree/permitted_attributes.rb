module Spree
  module PermittedAttributes
    ...
    # 状态，折扣，备注，过期时间
    @@card_attributes = [ :store_id, :created_by_id, :code, :variant_id, :amount, :status, :discount_percent, :memo, :expire_at, :state, :payment_password, :money]

    @@checkout_attributes = [
      :coupon_code, :email, :shipping_method_id, :special_instructions, :use_billing, :user_id, :store_id,
      :order_type, :created_by_id, :enable_sms, :enable_mp_msg, :memo, :odd_card_paid, :card_id
    ]

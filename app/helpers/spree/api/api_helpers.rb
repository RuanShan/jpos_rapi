module Spree
  module Api
    module ApiHelpers
      ...
      @@card_attributes = [
        :id, :store_id, :user_id, :code, :style, :amount, :amount_used, :card_times, :card_times_used,
      ...
      @@sale_day_attributes = [
        :day, :service_total, :deposit_total, :service_order_count, :new_orders_count, :new_customers_count, :new_cards_count, :service_posable_total
      ]

class WxPluginService
  ...
  class << self
    ...
    def fetch_component_access_token
      post_body = {
        component_appid:         Rails.application.secrets.wx_open.component_appid,
        component_appsecret:     Rails.application.secrets.wx_open.component_appsecret,
    ...
    def fetch_pre_auth_code
      ...
      post_body = {component_appid: Rails.application.secrets.wx_open.component_appid}.to_json
    ...
    def fetch_wx_mp_user_api_auth(auth_code, site)
      ...
      post_body = { component_appid: Rails.application.secrets.wx_open.component_appid, authorization_code: auth_code }.to_json
      result = HTTParty.post(url, body: post_body)
...
# scope        = 'snsapi_base'
# url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=#{app_id}&redirect_uri=#{redirect_uri}&response_type=code&scope=#{scope}&state=my_state&component_appid=#{Rails.application.secrets.wx_open.component_appid}#wechat_redirect"

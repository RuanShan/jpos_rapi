...
module Spree
  class Order < Spree::Base
    ...
    self.whitelisted_ransackable_attributes = %w[store_id completed_at email number state payment_state group_state shipment_state total order_type created_at updated_at user_id odd_card_paid odd_store_id]

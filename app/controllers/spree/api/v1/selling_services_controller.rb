      ...
      class SellingServicesController < ProductsController
        ...
        def product_scope
          if @current_user_roles.include?('admin')
            scope = Selling::Service.with_deleted.accessible_by(current_ability, :read).includes(*product_includes)

            scope = scope.not_deleted unless params[:show_deleted]
            scope = scope.not_discontinued unless params[:show_discontinued]
          else
            scope = Selling::Service.accessible_by(current_ability, :read).active.includes(*product_includes)
          end
